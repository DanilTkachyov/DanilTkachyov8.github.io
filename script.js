document.addEventListener("DOMContentLoaded", function () {
  ...
  const URL = "https://formcarry.com/s/8q7xM6-Dai9";
  ...
  form.addEventListener("submit", function (e) {
    ...
    if(check.checked){
      ...
      xhr.onload = function () {
       ...
       else{alert(`Запрос удачно обработан!`);
         console.log(xhr.response);
        }
      }; 
    xhr.onerror = function (){ alert("Вызвать запрос не удалось");};
    }
    else {alert("Необходимо согласие!");}
  });
});
